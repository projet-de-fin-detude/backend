                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('register.custom') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" placeholder="family_name" id="family_name" class="form-control"
                                    name="family_name" required autofocus>
                                @if ($errors->has('family_name'))
                                <span class="text-danger">{{ $errors->first('family_name') }}</span>
                                @endif
                            </div>
                            <div class="form-group mb-3">
                                <input type="text" placeholder="phone_number" id="phone_number" class="form-control"
